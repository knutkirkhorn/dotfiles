...
| `scripts/sync-clickup-weekly-meetings.test.ts`  | Tests weekly meeting and duty calendar URL validation, local week dates, Friday day-off calendar detection, and idempotent ClickUp time-entry planning                                                                          |
